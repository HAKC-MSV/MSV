...
extern llvm::cl::opt<std::string> EntryFunction;
extern llvm::cl::opt<bool> EnableOOWAnalysis;
extern llvm::cl::opt<bool> DebugFDFA;
extern llvm::cl::opt<bool> DebugDG;
extern llvm::cl::opt<bool> UsePC;
extern llvm::cl::opt<bool> DEBUG_SWITCH;
...
extern std::string NORMAL_MAGIC_ASM_BEGIN;
extern std::string NORMAL_MAGIC_ASM_END;

#define UMS_DEBUG(S, C)                                                        \
  do {                                                                         \
    if (S)                                                                     \
      C                                                                        \
  } while (0)
...
namespace UnifiedMemSafe {
	...
	private:
		int numFunctions = 0;
	public:
        std::unordered_map<VariableMapKeyType const *, VariableInfo> Variables;
        AnalysisState();
